...
export default function GaneshPoojaPage() {
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#aarti" className={`${themeStyles.text} hover:text-yellow-300 transition-colors duration-200 font-medium digital-text`}>
                Book Aarti
              </a>
              <a href="#events" className={`${themeStyles.text} hover:text-yellow-300 transition-colors duration-200 font-medium digital-text`}>
                Participate
              </a>
              <Link href="/gallery" className={`${themeStyles.text} hover:text-yellow-300 transition-colors duration-200 font-medium digital-text`}>
                Gallery
              </Link>
              <Link href="/participation-overview" className={`${themeStyles.text} hover:text-yellow-300 transition-colors duration-200 font-medium digital-text`}>
                Participation
              </Link>
            </div>
            ...
            <div className="md:hidden mobile-menu-container">
              <div className="relative">
                <button 
                  ...
                  className={`${themeStyles.text} hover:text-yellow-300 transition-colors duration-200 p-2`}
                >
                      ...
                      >
                        ...
                        <div className="py-2">
                          <a 
                            href="#aarti" 
                            onClick={() => setShowMobileMenu(false)}
                            className={`flex items-center px-4 py-3 ${themeStyles.text} hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 digital-text`}
                          >
                        ...
                        <div className="px-4 py-3 border-t border-gray-100">
                          <Link 
                            href="/"
                            onClick={() => setShowMobileMenu(false)}
                            className={`flex items-center ${themeStyles.accent} hover:text-blue-700 font-medium digital-text`}
                          >
